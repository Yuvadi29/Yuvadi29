...
<!-- YOUTUBE-VIDEOS-LIST:START --><div style="border: 1px solid #ccc; border-radius: 8px; padding: 12px; display: flex; align-items: center;">
  ...
  <div style="flex-grow: 1; text-align: center;">
    <a href="https://www.youtube.com/watch?v=t_4Sr7QIWm4" style="display: block; font-weight: bold; margin-bottom: 6px;">HONEST PLACEMENT PODCAST f.t Vasu Kothamasu |  Episode 20</a> (Dec 17, 2024)<br/>
